...
\begin{tikzpicture}[scale=0.75]
  % Slow turn (tight) — car at bottom, path curving ahead to the right
  \begin{scope}[shift={(-4.5,0)}]
    % The car starts pointing up, turns right along a tight arc
    \draw[roadgrey,very thick,-{Stealth}] (0,-2) arc (180:80:1.5);
    % Car at the start of the arc, pointing up
    \drawcar{0}{-2}{0}
    % Radius line from centre of arc to car
    \draw[black!50,dashed] (1.5,-2) -- (0,-2);
    \node[font=\tiny,black!50,above] at (0.75,-2) {small radius};
    % Centre dot
    \fill[black!30] (1.5,-2) circle (0.06);
    \node[font=\footnotesize\bfseries] at (0.5,-3.2) {Slow = tight turn};
  \end{scope}
  % Fast turn (wide) — car at bottom, path curving ahead gently to the right
  \begin{scope}[shift={(4,0)}]
    % Same starting position, but much wider arc
    \draw[roadgrey,very thick,-{Stealth}] (0,-2) arc (180:120:4);
    % Car at the start of the arc, pointing up
    \drawcar{0}{-2}{0}
    % Radius line from centre of arc to car
    \draw[black!50,dashed] (4,-2) -- (0,-2);
    \node[font=\tiny,black!50,above] at (2,-2) {large radius};
    % Centre dot
    \fill[black!30] (4,-2) circle (0.06);
    \node[font=\footnotesize\bfseries] at (0.5,-3.2) {Fast = wide turn};
  \end{scope}
\end{tikzpicture}
\end{center}
